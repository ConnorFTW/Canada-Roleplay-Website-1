<?php 
// CAD URL \\
define('BASE_URL', 'https://cad.canada-roleplay.com');

// SQL DATABASE CONNECTION \\
define('DB_HOST', 'localhost');
define('DB_USER', 'fxxbeexo');
define('DB_PASSWORD', 'Cjms_cjms10');
define('DB_NAME', 'fxxbeexo_cad');

// DISCORD OAUTH2 \\
define('TOKEN', 'ODM4MjUzNTAzMjAxMDE3ODU3.YI4aaQ.xbE6_EqYCOP0wKLpO9KBhFeWZVg');
define('GUILD_ID', '880241255043452959');
define('OAUTH2_CLIENT_ID', '838253503201017857');
define('OAUTH2_CLIENT_SECRET', '38uUtrQPYG7lOFLRvt1L3Ykp9hEZs1zM');
...
define('LOGS_IMAGE', 'https://canada-roleplay.com/Canada%20Roleplay_files/CRPDevPortal_Main.png');
...
// GENERAL SETTINGS \\
define('SERVER_SHORT_NAME', 'Canada Roleplay');
